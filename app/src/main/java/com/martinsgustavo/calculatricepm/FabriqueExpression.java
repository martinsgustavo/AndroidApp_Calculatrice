...
public class FabriqueExpression {
    ...
    //Méthode pour résoudre les expressions polonaises
    ...
    //Méthode pour résoudre les expressions régulières
    ...
    //Méthode pour appeler les classes des operandes
    private Expression faireCalcul(Expression n2, Expression n1, char oper) {
        switch (oper) {
            case '+':
    ...
    //Méthode pour la priorité des calculs
    private boolean calculAFaire (char a, char b) {
        if (b == '(' || b == ')') return false;
